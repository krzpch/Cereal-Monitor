...
Welcome to ``Cereal-Monitor`` contributor's guide.
...
If you experience bugs or general issues with ``Cereal-Monitor``, please have a look
...
You can help improve ``Cereal-Monitor`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Cereal-Monitor`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Cereal-Monitor``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Cereal-Monitor python=3 six virtualenv pytest pytest-cov
    conda activate Cereal-Monitor
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Cereal-Monitor.git
    cd Cereal-Monitor
...
#. Install |pre-commit|_::
   ...
   ``Cereal-Monitor`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Cereal-Monitor
.. _issue tracker: https://github.com/<USERNAME>/Cereal-Monitor/issues
.. <-- end -->
